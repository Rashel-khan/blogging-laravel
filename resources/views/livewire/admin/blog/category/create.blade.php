<div>
    ...
    <form class="bg-gray-100 dark:bg-gray-800 rounded p-4" wire:submit.prevent="create">
        <div class="grid grid-cols-1 gap-6 my-2 sm:grid-cols-2">
            ...
            <div>
                ...
                <x-input id="slug" wire:model.defer="form.slug" placeholder="Category Slug ( optional )"/>
            ...
            <div class="mb-4 p-2 text-sm w-full text-gray-700 dark:text-gray-300">
                ...
                <div class="" x-data="previewImage()">
                    ...
                    <div>
                        ...
                        <x-jet-input class="cursor-pointer" type="file" wire:model.defer="form.banner"
                                     id="banner" @change="fileChosen"
                                     accept="image/png, image/gif, image/jpeg"></x-jet-input>
                        <x-jet-input-error for="form.banner"/>
                    </div>
                </div>
            </div>
        </div>
