<header
    class="flex items-center justify-between px-6 py-4 bg-gray-100 dark:bg-gray-800/20 dark:bg-opacity-25 border-b-4
    border-orange-400 transition-all duration-300 transform shadow-md bg-opacity-25 backdrop-blur-lg z-[999] ">
...
<script>
    ...
    let themeToggleDarkIconLg = document.getElementById('theme-toggle-dark-iconLg');
    // var themeToggleLightIcon = document.getElementById('theme-toggle-light-icon');
    let themeToggleLightIconLg = document.getElementById('theme-toggle-light-iconLg');
