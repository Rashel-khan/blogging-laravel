            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:col-span-2">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <a href="mailto:rashel@retrievalit.xyz"
                               class="flex items-center justify-center gap-1.5 sm:justify-start">
                                ...
                                <span class="text-gray-700">rashel@retrievalit.xyz</span>
                            </a>
                        </li>

                        <li>
                            <a href="tel://+8801764047882"
                               class="flex items-center justify-center gap-1.5 sm:justify-start">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 shrink-0 text-gray-900"
                                ...
                                <span class="text-gray-700">01764047882</span>
                            </a>
                        </li>
