<div {!! $attributes->merge(['class'=>'relative my-[16px]']) !!}  data-te-input-wrapper-init>
    <input {!! $attributes->merge(['type'=> '']) !!}
           class="peer block min-h-[auto] w-full rounded border-0 focus:ring-0 bg-transparent px-3 py-3 leading-[1.6]
        ...
        [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
           ...
           placeholder="{!! $attributes->get('placeholder')?? $attributes->get('placeholder') !!} "/>
